...
namespace Modulos.Tests.Pipes
{
    ...
    public class Pipeline_modify_collection_tests
    {
        ...
        public void Add_wrong_type__FORBIDDEN()
        {
            ...
            var logic = new Action(() => { pipeline.Add(typeof(NotPipe)); });
        ...
        public void AddOrReplace_wrong_type__FORBIDDEN()
        {
            ...
            var logic = new Action(() => { pipeline.AddOrReplace(typeof(NotPipe)); });
        ...
        public void Remove__wrong_type__FORBIDDEN()
        {
            ...
            var logic = new Action(() => { pipeline.Remove(typeof(NotPipe)); });
        ...
        public void Insert_wrong_type__FORBIDDEN()
        {
            var sp = new Mock<IServiceProvider>();
            var pipeline = new Pipeline(sp.Object);
            var logic = new Action(() => { pipeline.Insert(InsertMode.Before, typeof(NotPipe), typeof(Pipe1)); });

            logic.Should().ThrowExactly<ArgumentException>();

            logic = () => { pipeline.Insert(InsertMode.Before, typeof(Pipe1), typeof(NotPipe)); };
